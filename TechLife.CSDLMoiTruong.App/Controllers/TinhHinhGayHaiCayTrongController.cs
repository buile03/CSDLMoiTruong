...
namespace TechLife.CSDLMoiTruong.App.Controllers
{
    public class TinhHinhGayHaiCayTrongController : BaseController
    {
        ...
        {
            var listLoaiCayTrong = await _tinhHinhGayHaiCayTrongService.GetAll();
        ...
        public async Task<IActionResult> ImportExcel(ImportExcelRequest request)
        {
            try
            {
                ...
                request.UserId = User.GetUserId();
                return await ActionResult(await _tinhHinhGayHaiCayTrongService.ImportExcel(request));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> ExportExcel(ExportExcelRequest request)
        {
            ...
            {
                request.UserId = User.GetUserId();
                return await _tinhHinhGayHaiCayTrongService.ExportExcel(request);
            }
            catch (Exception ex)
            {
